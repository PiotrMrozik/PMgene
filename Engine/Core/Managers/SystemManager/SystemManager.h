...
namespace PMgene::Core
{
	...
	class SystemManager : public ISubscriber, std::enable_shared_from_this <SystemManager>
	{
	public:
	/*	SystemManager(const std::shared_ptr<CommunicationManager>& communicationManagerPointer)
			: ISubscriber(communicationManagerPointer)
		{
		}*/
